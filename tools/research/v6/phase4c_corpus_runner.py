"""V6 Phase 4C movement normalization study -- corpus runner.
...
V6 Phase 4C movement-normalized research Ruleset
(``bytefray-rules-6-research-scale-move``), producing genuine,
...
Usage:
    python -m tools.research.v6.phase4c_corpus_runner fingerprints
    python -m tools.research.v6.phase4c_corpus_runner smoke
    python -m tools.research.v6.phase4c_corpus_runner equivalence
    python -m tools.research.v6.phase4c_corpus_runner sweep --arena-size 512
"""
...
def cmd_equivalence(args: argparse.Namespace) -> None:
    ...
    and research-scale-move (Phase 4C candidate) -- the direct live evidence
    for the equivalence gate."""
    results = {}
    for ruleset_id, label in (
        (BYTEFRAY_RULESET_V6_RESEARCH_SCALE_ID, "research-scale"),
        (BYTEFRAY_RULESET_V6_RESEARCH_SCALE_MOVE_ID, "research-scale-move"),
    ):
