...
# V6 E4 (docs/research/v6/V6_E4_MIRRORED_PASS_ORDER_REGISTRATION.md): the two
# mirrored-pass-order research Rulesets' own labels, for the same reason --
...
# V6 E6 (docs/research/v6/V6_E6_PRICED_SENSING_PREREGISTRATION.md): the two
# priced-sensing research Rulesets' own labels, for the same reason -- neither
# artifact may pass for its parent's from the mode label alone.
...
def is_ruleset_v6_research_scale_move_methodology(rules_compatibility_id: str) -> bool:
    """Whether a resolved rules-compatibility id is the V6 Phase 4C movement-normalized research Ruleset.

    True only for ``BYTEFRAY_RULESET_V6_RESEARCH_SCALE_MOVE_ID``
    (``bytefray-rules-6-research-scale-move``, docs/research/v6/
    V6_PHASE4C_MOVEMENT_NORMALIZATION_STUDY.md).
    """
...
def is_ruleset_v6_research_capture_hold_disruption_slot_mirrored_passes_methodology(
    rules_compatibility_id: str,
) -> bool:
    """Whether a resolved rules-compatibility id is the V6 E4 primary treatment.

    True only for
    ``BYTEFRAY_RULESET_V6_RESEARCH_CAPTURE_HOLD_K2_DISRUPTION_SLOT1_MIRRORED_PASSES_ID``
    (``bytefray-rules-6-research-capture-hold-k2-disruption-slot1-mirrored-passes``,
    docs/research/v6/V6_E4_MIRRORED_PASS_ORDER_REGISTRATION.md). Deliberately
...
def is_ruleset_v6_research_disruption_slot_mirrored_passes_methodology(
    rules_compatibility_id: str,
) -> bool:
    """Whether a resolved rules-compatibility id is the V6 E4 companion treatment.

    True only for ``BYTEFRAY_RULESET_V6_RESEARCH_DISRUPTION_SLOT1_MIRRORED_PASSES_ID``
    (``bytefray-rules-6-research-disruption-slot1-mirrored-passes``, docs/
    research/v6/V6_E4_MIRRORED_PASS_ORDER_REGISTRATION.md). Deliberately not
...
def is_ruleset_v6_research_sensing_r32_methodology(rules_compatibility_id: str) -> bool:
    """Whether a resolved rules-compatibility id is the V6 E6 primary treatment.

    True only for ``BYTEFRAY_RULESET_V6_RESEARCH_SENSING_R32_ID``
    (``bytefray-rules-6-research-sensing-r32``, docs/research/v6/
    V6_E6_PRICED_SENSING_PREREGISTRATION.md). Deliberately not a widening of
    the research-scale predicate, which stays true only for its parent
    identity itself.
    """

    return rules_compatibility_id == BYTEFRAY_RULESET_V6_RESEARCH_SENSING_R32_ID


def is_ruleset_v6_research_disruption_slot_sensing_r32_methodology(
    rules_compatibility_id: str,
) -> bool:
    """Whether a resolved rules-compatibility id is the V6 E6 companion treatment.

    True only for ``BYTEFRAY_RULESET_V6_RESEARCH_DISRUPTION_SLOT1_SENSING_R32_ID``
    (``bytefray-rules-6-research-disruption-slot1-sensing-r32``, docs/
    research/v6/V6_E6_PRICED_SENSING_PREREGISTRATION.md). Deliberately not a
    widening of the E3 companion's predicate, which stays true only for the
    E3 identity itself.
    """
...
def is_ruleset_v4_derived_methodology(rules_compatibility_id: str) -> bool:
    ...
    return (
        ...
        or is_ruleset_v6_research_capture_hold_disruption_slot_mirrored_passes_methodology(
            rules_compatibility_id
        )
...
def resolved_arena_alignment_mode(
    ...
    *,
    ...
    if is_v6_research_disruption_slot_mirrored_passes_methodology:
        return EVALUATION_ARENA_ALIGNMENT_MODE_V6_RESEARCH_DISRUPTION_SLOT1_MIRRORED_PASSES
...
def arena_alignment_mode_for_ruleset(rules_compatibility_id: str, group: bool = False) -> str:
    ...
    return resolved_arena_alignment_mode(
        ...
        is_v6_research_sensing_r32_methodology=is_ruleset_v6_research_sensing_r32_methodology(rules_compatibility_id),
...
class EvaluationRequest:
    ...
    @property
    def is_v6_research_scale_move_methodology(self) -> bool:
    ...
    @property
    def is_v6_research_capture_hold_disruption_slot_mirrored_passes_methodology(self) -> bool:
        """Whether this request's resolved Ruleset is the V6 E4 primary treatment identity."""

        return is_ruleset_v6_research_capture_hold_disruption_slot_mirrored_passes_methodology(
            self.resolved_rules_compatibility_id
        )

    @property
    def is_v6_research_disruption_slot_mirrored_passes_methodology(self) -> bool:
    ...
    @property
    def is_v6_research_sensing_r32_methodology(self) -> bool:
        """Whether this request's resolved Ruleset is the V6 E6 primary treatment identity."""

        return is_ruleset_v6_research_sensing_r32_methodology(self.resolved_rules_compatibility_id)

    @property
    def is_v6_research_disruption_slot_sensing_r32_methodology(self) -> bool:
